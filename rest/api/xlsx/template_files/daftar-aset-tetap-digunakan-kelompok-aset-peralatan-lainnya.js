...
module.exports = function (data) {
    ...
    var sit = wb.addWorksheet('Daftar Aset Tetap Digunakan Peralatan Lain')
    ...
    sit.cell(14, 1, 14, 29, true)
        .string('KELOMPOK ASET : PERALATAN LAIN')
        .style(
            {
                font: {
                    bold: true,
    ...
    for (var j = 0; j < sub_header[0].length; j++) {
        ...
        for (var i = 0; i < body_len; i++) {
            ...
            item.nilai_residu !== null ? sum_nilai_residu += parseFloat(item.nilai_residu) : sum_nilai_residu += parseFloat(0)
