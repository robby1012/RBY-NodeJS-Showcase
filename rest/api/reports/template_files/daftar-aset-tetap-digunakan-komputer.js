...
module.exports = function (data) {
	...
	for (var j = 0; j < sub_header[0].length; j++) {
		...
		dataBody.push([
			...
			{ text: sub_header[0][j].toUpperCase(), bold: true, colSpan: 4, style: 'tSubHeader' },
			{ text: '', style: 'tBody' },
			{ text: '', style: 'tBody' },
			{ text: '', style: 'tBody' },
			{ text: '', style: 'tBody' },
		...
		for (var i = 0; i < body_len; i++) {
			...
			sum_nil += parseInt(item.nilai_perolehan)
			sum_nilai_residu += parseFloat(data[j].nilai_residu !== null ? data[j].nilai_residu : '0')
			...
			sum_akum_sd_bln_ini += parseInt(item.akum_peny_sd_bln_ini)
			...
			tot_nil += parseInt(item.nilai_perolehan)
			tot_nilai_residu += parseFloat(data[j].nilai_residu !== null ? data[j].nilai_residu : '0')
			...
			tot_akum_sd_bln_ini += parseInt(item.akum_peny_sd_bln_ini)
			tot_nilai_buku_bln_ini += item.nilai_buku_bln_ini
			dataBody.push([
				{ text: (i + 1), style: 'tNumber' },
				...
				{ text: item.tgl_beli !== null ? moment(item.tgl_beli).format('DD-MM-YYYY') : '-', style: 'tBody' },
				{ text: item.umur_manfaat, style: 'tBody' },
				{ text: item.sd_thn_lalu !== null ? item.sd_thn_lalu : '-', style: 'tBody' },
				{ text: item.thn_ini !== null ? item.thn_ini : '-', style: 'tBody' },
				{ text: item.sd_tahun_ini !== null ? item.sd_tahun_ini : '-', style: 'tBody' },
				{ text: currency(item.nilai_perolehan), style: 'tBody' },
				{ text: currency(item.nilai_residu), style: 'tBody' },
				{ text: currency(item.akum_sd_thn_lalu), style: 'tBody' },
				{ text: '-', style: 'tBody' },
				{ text: '-', style: 'tBody' },
				{ text: currency(item.nilai_yg_disusutkan), style: 'tBody' },
				{ text: '-', style: 'tBody' },
				{ text: currency(item.peny_sd_bln_lalu), style: 'tBody' },
				{ text: item.peny_bln_ini !== null ? currency(item.peny_bln_ini) : currency(0), style: 'tBody' },
				{ text: currency(item.peny_sd_bln_ini), style: 'tBody' },
		...
		dataBody.push(
			[
				...
				{ text: 'JUMLAH', colSpan: 11, style: 'tSubHeader' },
				{ text: '', style: 'tBody' },
				{ text: '', style: 'tBody' },
				{ text: '', style: 'tBody' },
				{ text: '', style: 'tBody' },
		...
		content: [
			{
				...
				table: {
					...
					widths: [6, 8, 10, 10, 10, 25, 18, 21, 10, 30, 25, 25, 30, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 10, 10, 10, 10, 60],
					dontBreakRows: true,
					headerRows: 3,
					body: [
						[
							{ text: 'NO', bold: true, rowSpan: 2, alignment: 'center', style: 'headerBody', margin: [0, 15, 0, 0] },
							{ text: 'NO REGISTRASI', bold: true, rowSpan: 2, colSpan: 4, alignment: 'center', style: 'headerBody' },
							'',
							'',
							'',
							...
							{ text: 'BEBAN PENYUSUTAN TH BERJALAN', bold: true, colSpan: 3, alignment: 'center', style: 'headerBody' },
							'',
							'',
							...
							{ text: 'KONDISI', bold: true, colSpan: 4, alignment: 'center', style: 'headerBody' },
							'',
							'',
							'',
						...
						[
							{
								...
								table: {
									...
									body: [
										[
											{ text: '0', style: 'tSubHeader' },
											{ text: 'JUMLAH TOTAL', colSpan: 11, style: 'tSubHeader' },
											{ text: '', style: 'tBody' },
											{ text: '', style: 'tBody' },
											{ text: '', style: 'tBody' },
											{ text: '', style: 'tBody' },
										...
										[
											{ text: '', alignment: 'center', colSpan: 3, border: [false, false, false, false], style: 'tSubHeader', colSpan: 15 },
											'',
											'',
											'',
											'',
											...
											'',
											'',
											{ fontSize: 10, bold: true, text: '\n\n' + 'JAKARTA' + ', ' + moment().format('DD MMMM YYYY'), alignment: 'center', colSpan: 14, border: [false, false, false, false] },
											'',
											'',
											'',
											'',
										...
										[
											{ fontSize: 10, bold: true, text: 'Mengetahui,\n\n\n\n\n\n\n', alignment: 'center', colSpan: 3, border: [false, false, false, false], colSpan: 15 },
											'',
											'',
											'',
											'',
											...
											'',
											'',
											{ fontSize: 10, bold: true, text: 'Yang membuat,\n\n\n\n\n\n\n', alignment: 'center', colSpan: 14, border: [false, false, false, false] },
											'',
											'',
											'',
											'',
										...
										[
											{ fontSize: 10, bold: true, text: data[0].assigned_mengetahui + '\n' + data[0].assigned_jabatan_mengetahui, alignment: 'center', colSpan: 3, border: [false, false, false, false], colSpan: 15 },
											'',
											'',
											'',
											'',
											...
											'',
											'',
											{ fontSize: 10, bold: true, text: data[0].assigned_membuat + '\n' + data[0].assigned_jabatan_membuat, alignment: 'center', colSpan: 14, border: [false, false, false, false] },
											'',
											'',
											'',
											'',
