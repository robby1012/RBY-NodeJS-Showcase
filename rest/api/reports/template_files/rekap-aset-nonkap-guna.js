...
module.exports = function (data) {
    ...
    for (var j = 0; j < sub_header[0].length; j++) {
        ...
        body.push(
            [
                { style: 'tSubHeader', colSpan: 8, text: sub_header[0][j] },
                '',
                '',
                '',
                '',
    ...
    return {
        ...
        header: function (currentPage, pageCount, pageSize) {
            ...
            if (currentPage === 1) {
                title.push({
                    text: 'BPJS KETENAGAKERJAAN RUSUNAWA ' + namaRusun + '\nREKAPITULASI ASET NON KAPITALISASI YANG MASIH DIGUNAKAN\n',
                    alignment: 'center',
                    bold: true,
                    fontSize: 10
                },
        ...
        content: [
            {
                ...
                table: {
                    widths: [20, 190, 50, 90, 40, 40, 40, 40],
                    headerRows: 2,
                    body: [
                        [
                        ...
                        [
                            {
                                ...
                                table: {
                                    ...
                                    body: [
                                        ...
                                        [
                                            { style: 'tSubFoot', text: '', alignment: 'center', colSpan: 3, border: [false, false, false, false] },
                                            '',
                                            '',
                                            { fontSize: 10, text: '\n\nJAKARTA, ' + moment().format('DD MMMM YYYY'), alignment: 'center', colSpan: 5, border: [false, false, false, false] },
                                            '',
                                            '',
                                            '',
                                            '',
                                        ...
                                        [
                                            { fontSize: 10, text: 'Mengetahui,\n\n\n\n\n\n', alignment: 'center', colSpan: 3, border: [false, false, false, false] },
                                            '',
                                            '',
                                            { fontSize: 10, text: 'Yang membuat,\n\n\n\n\n\n', alignment: 'center', colSpan: 5, border: [false, false, false, false] },
                                            '',
                                            '',
                                            '',
                                            '',
                                        ...
                                        [
                                            { fontSize: 10, text: data[0].assigned_mengetahui, alignment: 'center', colSpan: 3, border: [false, false, false, false] },
                                            '',
                                            '',
                                            { fontSize: 10, text: data[0].assigned_membuat, alignment: 'center', colSpan: 5, border: [false, false, false, false] },
                                            '',
                                            '',
                                            '',
                                            '',
                                        ...
                                        [
                                            { fontSize: 10, text: data[0].assigned_jabatan_mengetahui, alignment: 'center', colSpan: 3, border: [false, false, false, false] },
                                            '',
                                            '',
                                            { fontSize: 10, text: data[0].assigned_jabatan_membuat, alignment: 'center', colSpan: 5, border: [false, false, false, false] },
                                            '',
                                            '',
                                            '',
                                            '',
                ...
                table: {
                    ...
                    body: [
                        ...
                        [
                            ...
                            '',
                            '',
                            { fontSize: 10, text: '\n\nBatam, ' + moment().format('DD MMMM YYYY'), alignment: 'center', colSpan: 5, border: [false, false, false, false] },
                            '',
                            '',
                            '',
                            '',
                        ...
                        [
                            { fontSize: 10, text: 'Marsaid', alignment: 'center', colSpan: 3, border: [false, false, false, false] },
                            '',
                            '',
                            { fontSize: 10, text: 'Widio B. Rahmulyo', alignment: 'center', colSpan: 5, border: [false, false, false, false] },
                            '',
                            '',
                            '',
                            '',
